...
import { fetchBucketList, BucketListObject, fetchCountryInformations, CountryInformations, } from '../features/ninja_api/NinjaApiSlice';
import { AppDispatch } from '../app/store';
import { BucketListState, CountryInformationsState, Facts, FactsState } from '../interfaces/Interfaces';
        ...
        <>
            <div className='text-center pt-12'>
                <div className='flex flex-col items-center'>
                    ...
                    <input type="text" name="" id="" placeholder="Search by name" onChange={(e) => setSearch(e.target.value)} className='text-black w-3/4 sm:w-1/3 lg:w-72 rounded p-2 mt-4'/>
                </div>
                ...
                <div className='flex flex-col items-start ml-4 justify-start my-5 text-base'>
                    <p className='text-amber-400 font-bold text-2xl'>{countryInformation?.list[0].name}</p>
                    <div className='flex flex-col justify-start items-start mt-5 text-amber-400'>
